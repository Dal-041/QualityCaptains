...
public class CaptainsShieldModulation {
	...
	public static float SHIELD_HE_REDUCTION = 30f;
	
	public static float EMP_DAMAGE_TAKEN_REDUCTION = 35f;
	public static float SHIELD_RATE_BONUS = 20f;
	...
	//Go put this on a tech skill
	public static class Level6 implements ShipSkillEffect {

		public void apply(MutableShipStatsAPI stats, HullSize hullSize, String id, float level) {
			stats.getEmpDamageTakenMult().modifyMult(id, 1f - EMP_DAMAGE_TAKEN_REDUCTION / 100f);
		}
		...
		public String getEffectDescription(float level) {
			return "-" + (EMP_DAMAGE_TAKEN_REDUCTION) + "% EMP damage taken";
		}
	...
	public static class Level5 implements ShipSkillEffect {
		...
		public void apply(MutableShipStatsAPI stats, HullSize hullSize, String id, float level) {
			stats.getShieldTurnRateMult().modifyMult(id, 1f + SHIELD_RATE_BONUS / 100f);
		...
		public String getEffectDescription(float level) {
			return "+" + (int)(SHIELD_RATE_BONUS) + "% shield raise rate and shield turn rate";
		}
