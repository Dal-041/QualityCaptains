...
public class CaptainsSpecialModifications {
	...
	public static float BUILD_IN_XP_BONUS = 0.25f;
	...
	public static class Level4 implements ShipSkillEffect {
		...
		public String getEffectDescription(float level) {
			return "Able to build " + EXTRA_SMODS + " more permanent hullmod* into ships";
		}
	...
	public static class Level5 implements ShipSkillEffect {
		...
		public void apply(MutableShipStatsAPI stats, HullSize hullSize, String id, float level) {
			stats.getDynamic().getMod(Stats.MAX_LOGISTICS_HULLMODS_MOD).modifyFlat(id, EXTRA_LMODS);
		}
		...
		public String getEffectDescription(float level) {
			return "Able to apply " + EXTRA_LMODS + " more logstics hullmod into ships";
		}
